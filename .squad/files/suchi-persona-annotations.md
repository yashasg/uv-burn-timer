...
**Diagram note for Linka:** L1 is a hard gate every cold launch (Donatello M1). Asha's branch is the only non-trivial path off this screen — call it out visually.
...
- **Devon**: Multi-scenarios it (Fitz I × SPF 30 × UV 9 = "Short"; Fitz I × SPF 50 × UV 9 = still short). Validates the "240+ min" cap doesn't kick in for him (it won't — he's Fitz I). **Doesn't tap L3.**
...
- **Asha** — **RE-ATTESTATION MOMENT**: She doesn't re-take Accutane every day, but when her medication changes (start of new prescription, end of treatment), her body's photosensitivity changes. **The L1 cover firing on every cold launch is the re-attestation surface** — she sees the photosensitizer line every cold launch, can re-tap "see About" if her cohort membership has changed. **This is exactly why L1 fires every cold launch, not once-per-install (Donatello M1).** **Annotation: purple sticky on L1 cover — "Asha's re-attestation moment is here, on every cold launch."**
...
- **L1 hard gate** — annotate "Every cold launch" badge on Screen 1's box. This is Asha's re-attestation re-fire mechanism.
